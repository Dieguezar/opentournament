...
- **Entregables:** documentación final verificada; instalación limpia validada en GitHub Actions; datos demo; plantillas y política de seguridad; workflow manual de OWASP ZAP implementado (pendiente primera ejecución); pipeline semver de imágenes GHCR implementado (pendiente primer tag y visibilidad pública); release 1.0.0; observabilidad (Grafana opcional).
